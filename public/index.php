...
if ($authenticated && $csrfOK && $method === 'POST' && ($_POST['action'] ?? '') === 'check_updates') {
    $page = 'updates';
    $updateCheck = githubLatestRelease(trim((string) ($company['github_repository'] ?? '')));
}
